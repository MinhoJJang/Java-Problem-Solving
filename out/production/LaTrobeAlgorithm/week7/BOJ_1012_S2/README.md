    ...
    public static void BFS() {
        ...
        while (!queue.isEmpty()) {
            ...
            for (int i = 0; i < 4; i++) {
                ...
                // 지금 방문하려는 곳이 배추가 있으며, 이전에 방문하지 않았는지 체크.
...
그렇지 않으면 방문했던 곳을 계속 큐에 넣게 되면서
이미 검사한 위치를 다시 검사하는 불필요한 과정이 추가된다.

이 부분은 참고영상에서 자주 실수하는 부분 2번에 해당한다. 
